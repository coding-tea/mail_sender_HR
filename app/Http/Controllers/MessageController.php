...
use App\Http\Requests\MessageRequest as ModelRequest;
...
use Domain\DTOs\MessageDto as Dto;
use Domain\Services\MessageService;
...
class MessageController extends Controller
{
    ...
    public function index()
    {
        ...
        $queryBuilder = Message::paginate(10);
    ...
    public function update(Message $message, ModelRequest $ModelRequest)
    {
        $this->service->update(
            $message,
            Dto::fromRequest($ModelRequest)
    ...
    public function import(Request $request)
    {
        ...
        Excel::import(new MessageImport($validated['category_id']), $validated['file']);
