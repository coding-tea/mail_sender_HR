<div x-transition:enter="transform transition-transform duration-300" x-transition:enter-start="-translate-x-full"
    ...
    <nav x-show="currentSidebarTab == 'linksTab'" aria-label="Main" class="flex flex-col h-full">
        ...
        <div class="flex items-center justify-center flex-shrink-0 py-10">
            <a href="#">
                <img class="w-24 h-auto" src="{{ asset('assets/images/logo.png') }}" alt="logo" />
            </a>
        </div>
    ...
    {{-- emails --}}
    <section x-show="currentSidebarTab == 'emailsTab'">
        <h2 class="text-xl px-4 py-10">Emails</h2>
        <!-- Links -->
        <div class="flex-1 px-4 space-y-2 overflow-hidden hover:overflow-auto">
            <a href="#" class="flex items-center w-full space-x-2 text-white bg-blue-500 rounded-lg">
                <span aria-hidden="true" class="p-2 bg-blue-700 rounded-lg">
            ...
            <a href="#"
                ...
                <span aria-hidden="true"
                    class="p-2 transition-colors rounded-lg group-hover:bg-blue-700 group-hover:text-white">
                    <div class="w-6 h-6">
                        <i class="bi bi-bookmark-fill" style="font-weight: bold; font-size: 20px;"></i>
                    </div>
                </span>
    ...
    <section x-show="currentSidebarTab == 'messagesTab'">
        ...
        <div class="flex-1 px-4 space-y-2 overflow-hidden hover:overflow-auto">
            <a href="#" class="flex items-center w-full space-x-2 text-white bg-blue-500 rounded-lg">
                <span aria-hidden="true" class="p-2 bg-blue-700 rounded-lg">
                    <div class="w-6 h-6">
                        <i class="bi bi-chat-left-dots-fill" style="font-weight: bold; font-size: 20px;"></i>
                    </div>
                </span>
            ...
            <a href="#"
                ...
                <span aria-hidden="true"
                    class="p-2 transition-colors rounded-lg group-hover:bg-blue-700 group-hover:text-white">
                    <div class="w-6 h-6">
                        <i class="bi bi-send" style="font-weight: bold; font-size: 20px;"></i>
                    </div>
                </span>
